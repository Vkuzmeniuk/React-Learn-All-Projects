...
export default function WelcomePage() {
  ...
  const yCity = useTransform(scrollY, [0, 350], [0, -100]);
  const opacityCity = useTransform(
    scrollY,
    [0, 350, 400, 600],
    [1, 0.5, 0.5, 0]
  );
  const yHero = useTransform(scrollY, [0, 350], [0, -200]);
  const opacityHero = useTransform(scrollY, [0, 400, 600], [1, 1, 0]);

  const yText = useTransform(scrollY, [0, 200, 300, 600], [0, 50, 200, 450]);
